export function getHand(pDeck:any, hDeck:any) {
    var valueMatch:any=[], suitMatch={}, twoMatches=[], threeMatches=[], fourMatches=[]
    var hand={type: 'None'}
    ...
    const descending = values.sort((a:any, b:any) => {return b-a})
...
function checkFlush(suitMatch:any) {
